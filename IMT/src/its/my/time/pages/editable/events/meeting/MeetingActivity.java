...
public class MeetingActivity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstance) {
		...
		mPager.setAdapter(new MeetingPagerAdapter(getSupportFragmentManager(), event));
	...
	protected void initialiseActionBar() {
		...
		if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
			...
			newTabEvent.setText(MeetingPagerAdapter.TITLE_PAGE_DETAILS);
			newTabEvent.setTabListener(tabListener);
			mActionBar.addTab(newTabEvent);
			
			newTabOdj = getSupportActionBar().newTab();
			newTabOdj.setText(MeetingPagerAdapter.TITLE_PAGE_ODJ);
			newTabOdj.setTabListener(tabListener);
			mActionBar.addTab(newTabOdj);

			newTabParticipants = getSupportActionBar().newTab();
			newTabParticipants.setText(MeetingPagerAdapter.TITLE_PAGE_PARTICIPANTS);
			...
			newTabCommentaires.setText(MeetingPagerAdapter.TITLE_PAGE_COMMENTAIRES);
			newTabCommentaires.setTabListener(tabListener);
			mActionBar.addTab(newTabCommentaires);

			newTabPj = getSupportActionBar().newTab();
			newTabPj.setText(MeetingPagerAdapter.TITLE_PAGE_PJ);
			newTabPj.setTabListener(tabListener);
			mActionBar.addTab(newTabPj);
		} else {
			mActionBar.setNavigationMode(ActionBar.NAVIGATION_MODE_LIST);
			String[] items = new String[]{MeetingPagerAdapter.TITLE_PAGE_DETAILS, MeetingPagerAdapter.TITLE_PAGE_PARTICIPANTS, MeetingPagerAdapter.TITLE_PAGE_COMMENTAIRES, MeetingPagerAdapter.TITLE_PAGE_PJ};
