...
public class ComptesActivity extends MyTimeActivity {
	...
	public void remove(final int which) {
		...
		builder.setPositiveButton("Supprimer",
			...
			public void onClick(DialogInterface dialog, int index) {
				new CompteRepository(ComptesActivity.this).deleteCompte(ComptesActivity.this.comptes.get(which));
	...
	private class ComptesAdapter implements ListAdapter {
		...
		private final List<CompteBean> comptes;
		...
		public long getItemId(int position) {
			return this.comptes.get(position).getId();
		}
