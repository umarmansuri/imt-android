...
public class TaskPagerAdapter extends FragmentPagerAdapter {
	...
	public TaskPagerAdapter(FragmentManager fm, EventBaseBean event) {
		super(fm);
		this.event = event;
	}
	...
	public Fragment getItem(int position) {
		switch (position) {
		case INDEX_PAGE_EVENT:return new TaskDetailsFragment(event, EventBaseRepository.Types.TYPE_TASK);
