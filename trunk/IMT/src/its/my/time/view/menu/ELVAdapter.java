...
public class ELVAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            childViewHolder.childTitle = (TextView) convertView.findViewById(R.id.menu_item_title);
            childViewHolder.childIcone = (TextView) convertView.findViewById(R.id.menu_item_icone);
        ...
        childViewHolder.childIcone.setText("");
        return convertView;
	}
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            groupViewHolder.groupTitle = (TextView) convertView.findViewById(R.id.menu_item_title);
            groupViewHolder.groupIcone = (TextView) convertView.findViewById(R.id.menu_item_icone);
            convertView.setTag(groupViewHolder);
        } else {
        	groupViewHolder = (GroupViewHolder) convertView.getTag();
        }
        groupViewHolder.groupTitle.setText(objet.getNom());
        groupViewHolder.groupIcone.setText("");
	...
	class ChildViewHolder {
		...
		public TextView childIcone;
	}

	class GroupViewHolder {
		public TextView groupTitle;
		public TextView groupIcone;
	}
